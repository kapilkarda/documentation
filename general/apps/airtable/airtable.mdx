...
4. Copy **OAuth Redirect URL** from PreCallAI to **OAuth redirect URL** field.
...
9. Copy **Client ID** to **Client ID** field on PreCallAI.
10. Copy **Client secret** to **Client secret** field on PreCallAI.
