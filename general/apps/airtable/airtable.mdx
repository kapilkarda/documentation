...
4. Copy **OAuth Redirect URL** from Qcall AI to **OAuth redirect URL** field.
...
9. Copy **Client ID** to **Client ID** field on Qcall AI.
10. Copy **Client secret** to **Client secret** field on Qcall AI.
