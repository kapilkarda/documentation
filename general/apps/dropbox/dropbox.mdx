...
1. Copy **OAuth Redirect URL** from Qcall AI to **Redirect URIs** field and add it.
...
1. Copy **App key** to **App key** field on Qcall AI.
1. Copy **App secret** to **App secret** field on Qcall AI.
