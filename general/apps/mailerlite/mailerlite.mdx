...
6. Copy the token from the popup to the `API Key` field on PreCallAI.
7. Write any screen name to be displayed in PreCallAI.
8. Now, you can start using the MailerLite connection with PreCallAI.
