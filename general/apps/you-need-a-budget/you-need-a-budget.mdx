...
6. Copy **OAuth Redirect URL** from Qcall AI and paste it in **Redirect URI(s)** section.
...
9. Copy the **Client ID** value to the **Client ID** field on Qcall AI.
10. Copy the **Client Secret** value to the **Client Secret** field on Qcall AI.
11. Fill the **Screen Name** field on Qcall AI.
