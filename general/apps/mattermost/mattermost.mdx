...
5. Copy **OAuth Redirect URL** from PreCallAI to the **Callback URLs** field on Mattermost page.
6. Click on the **Save** button at the end of the form on Mattermost page.
7. Copy the **Client ID** value from the following page to the `Client ID` field on PreCallAI.
8. Copy the **Client Secret** value from the same page to the `Client Secret` field on PreCallAI.
