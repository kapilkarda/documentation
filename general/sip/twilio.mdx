  ...
  <Step title="Create Elastic SIP Trunking">
    ...
    <ul>
        <li>
            ...
            <ul>
                <li>
                    If you opt for the auth route, you need to specify the username and password in the next step when importing the number to Qcall AI.
                </li>
            </ul>
            <Frame>
            ...
            <ul>
                <li>
                    Currently Qcall AI SIP server does not have a static IP, so if you opt for the IP route, you need to whitelist all the IP addresses in the range like following:
                </li>
            </ul>
