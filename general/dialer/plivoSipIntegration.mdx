...
{/* 📷 TODO: screenshot — Buy New Number search/buy → /images/plivo/02-buy-number.jpeg (image not yet added) */}
...
{/* 📷 TODO: screenshot — Create Credentials List form → /images/plivo/05-create-credentials.jpeg (image not yet added) */}
