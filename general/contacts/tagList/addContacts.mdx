...
description: "This page will teach us how to add contacts to the tag list"
icon: "people"
---

The process of adding contacts to a [contact list](https://app.qcall.ai/admin/tags) is as quite simple. <br/> We can bulk upload contacts to a tag list via a .csv file or we can add the contacts manually.
...
✔ Click on the Name of the tag list , that you want to add the contacts to.
