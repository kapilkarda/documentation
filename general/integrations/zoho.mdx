...
5. Next, navigate to the "Tags" under "Contacts."

6. Click on any particular tag and then click on the "Create" button, linking it with Zoho. This should also confirm that Zoho is connected successfully.
