---
title: Neuphonic
description: "Bring your Neuphonic voice capabilities to Qcall AI for lifelike conversations."
---
...
<ul>
    ...
    <li>Go to the Integrations tab within your Qcall AI account.</li>
...
<ul>
    ...
    <li>Navigate to Assistant Settings in your Qcall AI dashboard.</li>
    ...
    <li>If you’ve created custom voices on Neuphonic, you can link and use them directly within Qcall AI.</li>
...
Now your Qcall AI assistant will engage users with lifelike, emotionally rich voices, powered by Neuphonic's advanced AI speech synthesis.
