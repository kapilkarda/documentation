---
title: LMNT
description: "Bring your LMNT voice capabilities to Qcall AI for lifelike conversations."
---
...
<ul>
    ...
    <li>Now, head over to your Qcall AI dashboard, go to the Integrations section, and select LMNT.</li>

    <li>Paste the copied API key into the provided field and click Save to successfully link LMNT with Qcall AI.</li>

</ul>

## Configure LMNT Voice Settings in Qcall AI

<ul>

    <li>Navigate to Assistant Settings within your Qcall AI account.</li>
